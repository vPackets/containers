...
if ip link show eth1 > /dev/null 2>&1; then
    ...
    ip route add 40.0.0.0/24 via 10.101.1.1 dev eth1 || true
    ip route add 50.0.0.0/24 via 10.101.1.1 dev eth1 || true
    # IPv6 Routes
    ip -6 route add fc00:0::/32 via fc00:0:101:1::1 dev eth1 || true
    ip -6 route add fc00:0:40::1/64 via fc00:0:101:1::1 dev eth1 || true
    ip -6 route add fc00:0:50::1/64 via fc00:0:101:1::1 dev eth1 || true
else
